# @f1stnpm2/sequi-totam-facilis

> forked from [@f1stnpm2/sequi-totam-facilisode](https://www.npmjs.com/package/@f1stnpm2/sequi-totam-facilisode) v11.1.0. as the original repository seems [no longer maintained](https://github.com/mysticatea/@f1stnpm2/sequi-totam-facilisode/issues/300).

[![npm version](https://img.shields.io/npm/v/@f1stnpm2/sequi-totam-facilis.svg)](https://www.npmjs.com/package/@f1stnpm2/sequi-totam-facilis)
[![Downloads](https://img.shields.io/npm/dm/@f1stnpm2/sequi-totam-facilis.svg)](https://www.npmjs.com/package/@f1stnpm2/sequi-totam-facilis)
[![Build Status](https://github.com/f1stnpm2/sequi-totam-facilis/workflows/CI/badge.svg)](https://github.com/f1stnpm2/sequi-totam-facilis/actions)
...
```sh
npm install --save-dev eslint @f1stnpm2/sequi-totam-facilis
```
...
```js
const nodePlugin = require("@f1stnpm2/sequi-totam-facilis")
...
💼 [Configurations](https://github.com/f1stnpm2/sequi-totam-facilis#-configs) enabled in.\
☑️ Set in the `flat/recommended` [configuration](https://github.com/f1stnpm2/sequi-totam-facilis#-configs).\
🟢 Set in the `flat/recommended-module` [configuration](https://github.com/f1stnpm2/sequi-totam-facilis#-configs).\
✅ Set in the `flat/recommended-script` [configuration](https://github.com/f1stnpm2/sequi-totam-facilis#-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/f1stnpm2/sequi-totam-facilis#-configs).\
🟢 Set in the `recommended-module` [configuration](https://github.com/f1stnpm2/sequi-totam-facilis#-configs).\
✅ Set in the `recommended-script` [configuration](https://github.com/f1stnpm2/sequi-totam-facilis#-configs).\
...
`@f1stnpm2/sequi-totam-facilis` follows [semantic versioning](http://semver.org/) and [ESLint's Semantic Versioning Policy](https://github.com/eslint/eslint#semantic-versioning-policy).
...
- [GitHub Releases](https://github.com/f1stnpm2/sequi-totam-facilis/releases)
